...
The documentation file you have to provide is at the `system` level, if you need
to add something at the `http` level, please open an issue or a pull request and
we'll discuss it.
